...
for num_secrets in secrets_to_try:
    ...
    for trial in range(0, 200, num_secrets):
        ...
        for secret_idx in range(twenty_percent_of_secrets):
        ...
        for secret_idx in range(twenty_percent_of_secrets, num_secrets*2):
    ...
    endAttack = time.time()
    print("Total time spent this round in seconds: " + str(endAttack-startAttack))
