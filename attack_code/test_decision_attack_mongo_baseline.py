...
def reshrink_table(compressor_size, filler_1_reset=False, db_count=0):
     size = get_table_size()
...
for num_secrets in secrets_to_try:
    ...
    for trial in range(0, 10):
        ...
        reshrink_table(compressor_size, db_count)
        ...
        for glen in guess_lens:
            ...
            reshrink_table(compressor_size, filler_1_reset=True, db_count=db_count)
